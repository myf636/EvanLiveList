 ...
 * 时间提醒的adapter
 */
public class Remind_Item_Adapter extends RecyclerView.Adapter<Remind_Item_Adapter.ViewHolder> {
    private MainActivity context;

    public Remind_Item_Adapter(MainActivity mainActivity) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.cardContainer.setId(2000 + position);
